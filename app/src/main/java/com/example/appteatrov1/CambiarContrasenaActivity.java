...
import java.util.Random; // Añadido para generar el código
...
public class CambiarContrasenaActivity extends AppCompatActivity {
    ...
    private int codigoGenerado; // Almacena el código de seguridad
            ...
            try {
                ...
                if (con != null) {
                    ...
                    if (rs.next()) {
                        ...
                        String sqlUpdate = "UPDATE usuario SET contrasena = ? WHERE email = ?";
                        ...
                        runOnUiThread(() -> {
                            Toast.makeText(this, "Contrasena restablecida con éxito", Toast.LENGTH_LONG).show();
                            finish();
                        });
                    } else {
                        runOnUiThread(() ->
